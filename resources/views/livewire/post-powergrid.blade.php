@section("pageTitle", ucwords($pageTitle))
<div>
    ...
    <div wire:ignore.self class="modal modal-blur fade" data-bs-backdrop="static" data-bs-keyboard="false"
        id="formModal" tabindex="-1" role="dialog" aria-labelledby="formModal" aria-hidden="true">
            ...
            <div class="modal-content">
                <form id="formSubmit" wire:submit.prevent="{{ $postId ? "update" : "store" }}">
                    ...
                    <div class="modal-body">
                        ...
                        <fieldset class="" wire:loading.attr="disabled">
                            <!-- Inline Form -->
                            <div class="row g-3">
                                <div class="col-12 col-md-12 mb-1">
                                    ...
                                    <input type="text" class="form-control @error("form.title") is-invalid @enderror"
                                        id="title" placeholder="Silahkan Masukan Judul" wire:model="form.title">
                                ...
                                <div class="col-12 col-md-12 mb-1">
                                    ...
                                    <input type="text" class="form-control @error("form.body") is-invalid @enderror"
                                        id="body" placeholder="Silahkan Masukan Konten" wire:model="form.body">
                                    <div class="invalid-feedback">
                                        @error("form.body")
                                            {{ $message }}
                                        @enderror
                    ...
                    <div class="modal-footer d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary" id="submitButton" wire:loading.attr="disabled">
